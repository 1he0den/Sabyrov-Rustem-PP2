...
background = pygame.image.load(r"C:\pp2\lab08\res_for_racer\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"C:\pp2\lab08\res_for_racer\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"C:\pp2\lab08\res_for_racer\car.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\pp2\lab08\res_for_racer\coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH-40), 0)
...
def game_start(): 
    ...
    while True:
        ...
        if pygame.sprite.spritecollideany(P1, coins_group):
            COINS_COUNTER += random.randint(1, 4)  # Randomly add 1 to 3 coins
            entity.kill()  # remove the coin

        if COINS_COUNTER % N == 0 and COINS_COUNTER != 0:
            SPEED += 1
        ...
        if pygame.sprite.spritecollideany(P1, enemies):
            pygame.mixer.Sound(r'C:\pp2\lab08\res_for_racer\crash.wav').play()
            time.sleep(0.5)
